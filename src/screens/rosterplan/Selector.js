    ...
    <>
      <View>
        ...
        <View style={styles.viewCustom}>
          <View style={{...styles.textContainer, color: themecolor.TXTWHITE,backgroundColor: themecolor.BOXTHEMECOLOR}}>
            <Picker
              mode="dropdown"
              style={{...styles.W, color: themecolor.TXTWHITE}}
              itemStyle={{...styles.H1, color: themecolor.TXTWHITE}}
              selectedValue={''}
