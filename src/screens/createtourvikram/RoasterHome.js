import {
  ...
  const TourTeam = ({ item, props,roles,themecolor }) => {
    ...
    return (
      <>
        <TouchableOpacity
          onPress={() => props.navigation.push('TourApproval', {empId: item.EmployeeId})}
          style={{
            flexDirection: 'row',
  ...
  export default function RoasterHome(props) {
                  ...
                  <View>
                    <View style={{ marginTop: 5 }}>
                      ...
                      <View
                        ...
                        <FullsizeButton title='Me' width={'100%'} backgroundColor={themecolor.HEADERTHEMECOLOR} onPress={()=>props.navigation.push('RoasterPlan', { screen: '',user:true })} />
