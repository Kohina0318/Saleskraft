...
SmallHeading:{
  ...
  TYPETEXT2:{flex: 1, marginLeft: 20, paddingVertical: 10},
  T1:{color: Colors.white, fontSize: 16, fontWeight: '600'},
  T2:{color: Colors.white, fontSize: 11},
  MT10:{marginTop: 10},
  NewView:{
    flex: 4,
    width: width * 0.93,
  ...
  MainVIewRound:{borderWidth:1,borderRadius:12,borderColor: Colors.borderColor, overflow: 'hidden',justifyContent:'space-between',margin:1,flex:1},
  RecentOrder41:{
    width: width * 0.41,
    paddingVertical: 5,
    borderBottomWidth: 1,
...
SalesView2:{flex: 2, alignItems: 'center', left: 10},
SalexTextBig:{
  color: Colors.bluetheme,
