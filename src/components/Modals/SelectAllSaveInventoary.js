...
export default function SelectAllSaveInventoary(props) {
                    ...
                    <View style={{...StyleCss.modalView,backgroundColor:themecolor.RB2}}>
                        <View style={StyleCss.ModalViewWidth}>
                            ...
                            <View style={StyleCss.FLexCenter}>
                                <FullsizeButton width={width * 0.32} fontsize={11} BRadius={30} height={30} backgroundColor={themecolor.HEADERTHEMECOLOR} onPress={() => {
                                    props.setSelectAllModal(!props.selectAllModal)
                                    props.setSelection(!props.isSelected)
                                }} title='Submit' />
